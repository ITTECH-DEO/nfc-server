...
function BrickletIO4V2(uid, ipcon) {
	...
	*/
	Device.call(this, this, uid, ipcon, BrickletIO4V2.DEVICE_IDENTIFIER, BrickletIO4V2.DEVICE_DISPLAY_NAME);
	...
	this.callbackFormats[BrickletIO4V2.CALLBACK_INPUT_VALUE] = [11, 'B ? ?'];
	this.callbackFormats[BrickletIO4V2.CALLBACK_ALL_INPUT_VALUE] = [10, '?4 ?4'];
	this.callbackFormats[BrickletIO4V2.CALLBACK_MONOFLOP_DONE] = [10, 'B ?'];
	...
	this.setValue = function(value, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_SET_VALUE, [value], '?4', 0, '', returnCallback, errorCallback, false, true);
	};
	this.getValue = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_GET_VALUE, [], '', 9, '?4', returnCallback, errorCallback, false, true);
	};
	this.setSelectedValue = function(channel, value, returnCallback, errorCallback) {
		...
		.. note::
		 ...
		 resistors can be switched on with :func:`Set Configuration`.
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_SET_SELECTED_VALUE, [channel, value], 'B ?', 0, '', returnCallback, errorCallback, false, true);
	};
	this.setConfiguration = function(channel, direction, value, returnCallback, errorCallback) {
		...
		* (3, 'o', false) will set channel 3 as output low.
		...
		function is called.
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_SET_CONFIGURATION, [channel, direction, value], 'B c ?', 0, '', returnCallback, errorCallback, false, true);
	};
	this.getConfiguration = function(channel, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_GET_CONFIGURATION, [channel], 'B', 10, 'c ?', returnCallback, errorCallback, false, true);
	};
	this.setInputValueCallbackConfiguration = function(channel, period, valueHasToChange, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_SET_INPUT_VALUE_CALLBACK_CONFIGURATION, [channel, period, valueHasToChange], 'B I ?', 0, '', returnCallback, errorCallback, false, true);
	};
	this.getInputValueCallbackConfiguration = function(channel, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_GET_INPUT_VALUE_CALLBACK_CONFIGURATION, [channel], 'B', 13, 'I ?', returnCallback, errorCallback, false, true);
	};
	this.setAllInputValueCallbackConfiguration = function(period, valueHasToChange, returnCallback, errorCallback) {
		...
		independent of the value.
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_SET_ALL_INPUT_VALUE_CALLBACK_CONFIGURATION, [period, valueHasToChange], 'I ?', 0, '', returnCallback, errorCallback, false, true);
	};
	this.getAllInputValueCallbackConfiguration = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_GET_ALL_INPUT_VALUE_CALLBACK_CONFIGURATION, [], '', 13, 'I ?', returnCallback, errorCallback, false, true);
	};
	this.setMonoflop = function(channel, value, time, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_SET_MONOFLOP, [channel, value, time], 'B ? I', 0, '', returnCallback, errorCallback, false, true);
	};
	this.getMonoflop = function(channel, returnCallback, errorCallback) {
		...
		as 0.
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_GET_MONOFLOP, [channel], 'B', 17, '? I I', returnCallback, errorCallback, false, true);
	};
	this.getEdgeCount = function(channel, resetCounter, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_GET_EDGE_COUNT, [channel, resetCounter], 'B ?', 12, 'I', returnCallback, errorCallback, false, true);
	};
	this.setEdgeCountConfiguration = function(channel, edgeType, debounce, returnCallback, errorCallback) {
		...
		* 2 = both
		...
		.. note::
		 Calling this function is only allowed for channels configured as input.
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_SET_EDGE_COUNT_CONFIGURATION, [channel, edgeType, debounce], 'B B B', 0, '', returnCallback, errorCallback, false, true);
	};
	this.getEdgeCountConfiguration = function(channel, returnCallback, errorCallback) {
		...
		.. note::
		 Calling this function is only allowed for channels configured as input.
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_GET_EDGE_COUNT_CONFIGURATION, [channel], 'B', 10, 'B B', returnCallback, errorCallback, false, true);
	};
	this.setPWMConfiguration = function(channel, frequency, dutyCycle, returnCallback, errorCallback) {
		...
		is called.
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_SET_PWM_CONFIGURATION, [channel, frequency, dutyCycle], 'B I H', 0, '', returnCallback, errorCallback, false, true);
	};
	this.getPWMConfiguration = function(channel, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_GET_PWM_CONFIGURATION, [channel], 'B', 14, 'I H', returnCallback, errorCallback, false, true);
	};
	this.getSPITFPErrorCount = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_GET_SPITFP_ERROR_COUNT, [], '', 24, 'I I I I', returnCallback, errorCallback, false, true);
	};
	this.setBootloaderMode = function(mode, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_SET_BOOTLOADER_MODE, [mode], 'B', 9, 'B', returnCallback, errorCallback, false, true);
	};
	this.getBootloaderMode = function(returnCallback, errorCallback) {
		/*
		Returns the current bootloader mode, see :func:`Set Bootloader Mode`.
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_GET_BOOTLOADER_MODE, [], '', 9, 'B', returnCallback, errorCallback, false, true);
	};
	this.setWriteFirmwarePointer = function(pointer, returnCallback, errorCallback) {
		...
		necessary to call it in a normal user program.
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_SET_WRITE_FIRMWARE_POINTER, [pointer], 'I', 0, '', returnCallback, errorCallback, false, true);
	};
	this.writeFirmware = function(data, returnCallback, errorCallback) {
		...
		necessary to call it in a normal user program.
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_WRITE_FIRMWARE, [data], 'B64', 9, 'B', returnCallback, errorCallback, false, true);
	};
	this.setStatusLEDConfig = function(config, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_SET_STATUS_LED_CONFIG, [config], 'B', 0, '', returnCallback, errorCallback, false, true);
	};
	this.getStatusLEDConfig = function(returnCallback, errorCallback) {
		/*
		Returns the configuration as set by :func:`Set Status LED Config`
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_GET_STATUS_LED_CONFIG, [], '', 9, 'B', returnCallback, errorCallback, false, true);
	};
	this.getChipTemperature = function(returnCallback, errorCallback) {
		...
		temperature changes.
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_GET_CHIP_TEMPERATURE, [], '', 10, 'h', returnCallback, errorCallback, false, true);
	};
	this.reset = function(returnCallback, errorCallback) {
		...
		undefined behavior!
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_RESET, [], '', 0, '', returnCallback, errorCallback, false, true);
	};
	this.writeUID = function(uid, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_WRITE_UID, [uid], 'I', 0, '', returnCallback, errorCallback, false, true);
	};
	this.readUID = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_READ_UID, [], '', 12, 'I', returnCallback, errorCallback, false, true);
	};
	this.getIdentity = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletIO4V2.FUNCTION_GET_IDENTITY, [], '', 33, 's8 s8 c B3 B3 H', returnCallback, errorCallback, false, false);
	};
