...
function BrickletNFCRFID(uid, ipcon) {
	...
	*/
	Device.call(this, this, uid, ipcon, BrickletNFCRFID.DEVICE_IDENTIFIER, BrickletNFCRFID.DEVICE_DISPLAY_NAME);
	...
	this.callbackFormats[BrickletNFCRFID.CALLBACK_STATE_CHANGED] = [10, 'B ?'];
	...
	this.requestTagID = function(tagType, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletNFCRFID.FUNCTION_REQUEST_TAG_ID, [tagType], 'B', 0, '', returnCallback, errorCallback, false, true);
	};
	this.getTagID = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletNFCRFID.FUNCTION_GET_TAG_ID, [], '', 17, 'B B B7', returnCallback, errorCallback, false, true);
	};
	this.getState = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletNFCRFID.FUNCTION_GET_STATE, [], '', 10, 'B ?', returnCallback, errorCallback, false, true);
	};
	this.authenticateMifareClassicPage = function(page, keyNumber, key, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletNFCRFID.FUNCTION_AUTHENTICATE_MIFARE_CLASSIC_PAGE, [page, keyNumber, key], 'H B B6', 0, '', returnCallback, errorCallback, false, true);
	};
	this.writePage = function(page, data, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletNFCRFID.FUNCTION_WRITE_PAGE, [page, data], 'H B16', 0, '', returnCallback, errorCallback, false, true);
	};
	this.requestPage = function(page, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletNFCRFID.FUNCTION_REQUEST_PAGE, [page], 'H', 0, '', returnCallback, errorCallback, false, true);
	};
	this.getPage = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletNFCRFID.FUNCTION_GET_PAGE, [], '', 24, 'B16', returnCallback, errorCallback, false, true);
	};
	this.getIdentity = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletNFCRFID.FUNCTION_GET_IDENTITY, [], '', 33, 's8 s8 c B3 B3 H', returnCallback, errorCallback, false, false);
	};
