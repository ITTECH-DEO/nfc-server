...
function BrickletRGBLEDButton(uid, ipcon) {
	...
	*/
	Device.call(this, this, uid, ipcon, BrickletRGBLEDButton.DEVICE_IDENTIFIER, BrickletRGBLEDButton.DEVICE_DISPLAY_NAME);
	...
	this.callbackFormats[BrickletRGBLEDButton.CALLBACK_BUTTON_STATE_CHANGED] = [9, 'B'];
	...
	this.setColor = function(red, green, blue, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_SET_COLOR, [red, green, blue], 'B B B', 0, '', returnCallback, errorCallback, false, true);
	};
	this.getColor = function(returnCallback, errorCallback) {
		/*
		Returns the LED color as set by :func:`Set Color`.
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_GET_COLOR, [], '', 11, 'B B B', returnCallback, errorCallback, false, true);
	};
	this.getButtonState = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_GET_BUTTON_STATE, [], '', 9, 'B', returnCallback, errorCallback, false, true);
	};
	this.setColorCalibration = function(red, green, blue, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_SET_COLOR_CALIBRATION, [red, green, blue], 'B B B', 0, '', returnCallback, errorCallback, false, true);
	};
	this.getColorCalibration = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_GET_COLOR_CALIBRATION, [], '', 11, 'B B B', returnCallback, errorCallback, false, true);
	};
	this.getSPITFPErrorCount = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_GET_SPITFP_ERROR_COUNT, [], '', 24, 'I I I I', returnCallback, errorCallback, false, true);
	};
	this.setBootloaderMode = function(mode, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_SET_BOOTLOADER_MODE, [mode], 'B', 9, 'B', returnCallback, errorCallback, false, true);
	};
	this.getBootloaderMode = function(returnCallback, errorCallback) {
		/*
		Returns the current bootloader mode, see :func:`Set Bootloader Mode`.
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_GET_BOOTLOADER_MODE, [], '', 9, 'B', returnCallback, errorCallback, false, true);
	};
	this.setWriteFirmwarePointer = function(pointer, returnCallback, errorCallback) {
		...
		necessary to call it in a normal user program.
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_SET_WRITE_FIRMWARE_POINTER, [pointer], 'I', 0, '', returnCallback, errorCallback, false, true);
	};
	this.writeFirmware = function(data, returnCallback, errorCallback) {
		...
		necessary to call it in a normal user program.
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_WRITE_FIRMWARE, [data], 'B64', 9, 'B', returnCallback, errorCallback, false, true);
	};
	this.setStatusLEDConfig = function(config, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_SET_STATUS_LED_CONFIG, [config], 'B', 0, '', returnCallback, errorCallback, false, true);
	};
	this.getStatusLEDConfig = function(returnCallback, errorCallback) {
		/*
		Returns the configuration as set by :func:`Set Status LED Config`
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_GET_STATUS_LED_CONFIG, [], '', 9, 'B', returnCallback, errorCallback, false, true);
	};
	this.getChipTemperature = function(returnCallback, errorCallback) {
		...
		temperature changes.
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_GET_CHIP_TEMPERATURE, [], '', 10, 'h', returnCallback, errorCallback, false, true);
	};
	this.reset = function(returnCallback, errorCallback) {
		...
		undefined behavior!
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_RESET, [], '', 0, '', returnCallback, errorCallback, false, true);
	};
	this.writeUID = function(uid, returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_WRITE_UID, [uid], 'I', 0, '', returnCallback, errorCallback, false, true);
	};
	this.readUID = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_READ_UID, [], '', 12, 'I', returnCallback, errorCallback, false, true);
	};
	this.getIdentity = function(returnCallback, errorCallback) {
		...
		*/
		this.ipcon.sendRequest(this, BrickletRGBLEDButton.FUNCTION_GET_IDENTITY, [], '', 33, 's8 s8 c B3 B3 H', returnCallback, errorCallback, false, false);
	};
